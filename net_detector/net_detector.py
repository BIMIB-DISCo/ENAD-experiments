...
class NetDetector:
    ...
    def train_layer_detectors(self, data_loader):
        ...
        detectors = []
        for layer_idx in tqdm(range(self.n_layers), disable=not self.tqdm, desc="Training layer detectors..."):
    ...
    def get_layer_scores(self, data_loader):
        ...
        scores = []
        for layer_idx in tqdm(range(self.n_layers), disable=not self.tqdm, desc="Extracting layer scores...", leave=False):
